...
> **Agentes de IA:** comecem por [`AGENTS.md`](AGENTS.md) e pela
> [`Central de continuidade`](docs/ai/README.md). Esses documentos preservam o
> contexto compartilhado do canal, da identidade visual e da pesquisa da
> carteira sem depender de conversas privadas.
...
Ver também [`docs/ALINHAMENTO-IA.md`](docs/ALINHAMENTO-IA.md) e o
[`snapshot interdisciplinar vigente`](docs/ai/SYNC-IA-DIVINO-BITCOIN-v2.md).
