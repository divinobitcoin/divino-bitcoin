 ...
 * pixel** da peça oficial de identidade visual, não estimadas a olho. Os
 ...
 * intuição. Um exemplo concreto, medido: **texto creme sobre âmbar dá 3,31:1 e
 ...
 * escuro: `obsidiana` sobre `ambarBitcoin` dá 5,36:1 e passa.
 *
 * ## Como usar
 *
...
export const identidade = {
  /** Fundo profundo, quase preto com viés frio. */
  obsidiana: "#080B0C",
  /** Cinza neutro para superfícies elevadas. */
  grafite: "#262626",
  /** Laranja de ação. A cor do Bitcoin no contexto da marca. */
  ambarBitcoin: "#CB6C18",
  /** Dourado sóbrio, para destaque e estado de rede. */
  ouroContido: "#DB9C48",
  /** Creme do logotipo. Texto principal sobre fundo escuro. */
  creme: "#FBF2DF",
  /** Dourado luminoso do símbolo. Reservado para acento raro. */
  ouroLuz: "#FEDF8B",
} as const;
...
export const cores = {
  ...
  superficieAlta: identidade.grafite,
   ...
   * Creme sobre âmbar dá 3,31:1 e reprova; obsidiana dá 5,36:1 e passa.
   */
